        ...
        <div className="bg-grey8 py-10">
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <a 
              href="./forgotPassword"
              className="text-end font-Inter font-medium text-[0.875rem] text-grey2">Esqueci minha senha</a>
            ...
            <p className="text-center font-Inter font-normal text-[0.875rem] text-grey2">Ainda não possui conta?</p>
